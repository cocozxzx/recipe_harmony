...
export class CategoryViewModel {
    ...
    private async loadTags(): Promise<void> {
        try {
            ...
            Logger.w(TAG, 'loadTags failed', e as Object);
        }
    }
    ...
    async reload(): Promise<void> {
        ...
        try {
            ...
            Logger.e(TAG, 'reload failed', e as Object);
