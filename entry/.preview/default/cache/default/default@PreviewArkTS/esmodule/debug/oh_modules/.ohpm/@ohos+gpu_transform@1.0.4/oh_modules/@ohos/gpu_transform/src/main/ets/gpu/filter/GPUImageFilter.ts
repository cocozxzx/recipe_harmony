import { NativeEglRender } from "@package:pkg_modules/.ohpm/@ohos+gpu_transform@1.0.4/pkg_modules/@ohos/gpu_transform/src/main/ets/gpu/gl/NativeEglRender";
import type { GPUFilterType } from '../gl/GPUFilterType';
